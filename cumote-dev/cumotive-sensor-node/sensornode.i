...
void            HAL_set_IRQ_mask        (void);
void            HAL_set_IRQ_mask_full   (unsigned char);
...
=============================================================*/ 
    ...
    // set by default to just enable TRX_END and RX_START
    COM_write_register(0x0E,0x08       |0x04       );
}
void    HAL_set_IRQ_mask_full (unsigned char mask)  {   // when calling, need to set parameter to the flags that are desired
    COM_write_register(0x0E,mask);
}
/*****************************************************************************
 * kxp74.h
